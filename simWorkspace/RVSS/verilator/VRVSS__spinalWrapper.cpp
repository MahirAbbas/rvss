...
public:
    ...
    Wrapper_1(const char * name){
      ...
      waveEnabled = true;
      signalAccess[0] = new CDataSignalAccess( top.RVSS->control_1->decode_1->io_operation );
      signalAccess[1] = new IDataSignalAccess( top.RVSS->datapath_1->fetch_1->io_instruction );
      signalAccess[2] = new IDataSignalAccess( top.RVSS->datapath_1->fetch_1->instructionMemory[0] );
      signalAccess[3] = new IDataSignalAccess( top.RVSS->datapath_1->datapathDecode_1->regFile_1->io_readData1 );
      signalAccess[4] = new IDataSignalAccess( top.RVSS->datapath_1->datapathDecode_1->regFile_1->io_readData2 );
      signalAccess[5] = new IDataSignalAccess( top.RVSS->datapath_1->datapathDecode_1->regFile_1->regFile_1[0] );
      signalAccess[6] = new IDataSignalAccess( top.RVSS->datapath_1->execute_1->alu_1->io_SrcA );
      signalAccess[7] = new IDataSignalAccess( top.RVSS->datapath_1->execute_1->alu_1->io_SrcB );
      signalAccess[8] = new IDataSignalAccess( top.RVSS->datapath_1->memory_1->dataMemory[0] );
      ...
      top.trace(&tfp, 99);
      tfp.open((std::string("/home/mahir/fun/spinalhdl/Digital-Design/rvss/./simWorkspace/RVSS/") + name + ".vcd").c_str());
      #endif
      this->name = name;
    ...
    virtual ~Wrapper_1(){
      ...
      #endif
      #ifdef COVERAGE
      VerilatedCov::write((("/home/mahir/fun/spinalhdl/Digital-Design/rvss/./simWorkspace/RVSS/") + name + ".dat").c_str());
      #endif
